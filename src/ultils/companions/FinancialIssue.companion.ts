import type { FinancialIssue } from "@open-source-economy/api-types";
...
export namespace FinancialIssueCompanion {
   ...
   */
  export function id(fi: FinancialIssue): string {
   ...
   */
  export function isClosed(fi: FinancialIssue): boolean {
   ...
   */
  export function amountCollected(fi: FinancialIssue): number {
   ...
   */
  export function amountRequested(fi: FinancialIssue): number | null {
   ...
   */
  export function successfullyFunded(fi: FinancialIssue): boolean {
