...
const AUDIENCE_COLORS = {
  ALL: {
    primary:
      "bg-gradient-to-r from-[#FF7E4B] via-[#FF518C] to-[#66319B] min-w-[210px] after:absolute after:w-[99%] after:top-1/2 after:left-1/2 after:bg-secondary after:h-[93%]  relative z-20 after:-z-10 after:-translate-x-1/2 after:-translate-y-1/2 after:rounded-md after:opacity-0 after:duration-300 rounded-md",
    secondary:
