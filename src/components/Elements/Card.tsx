    ...
    return (
        <>
            <div className="card__project">
                    ...
                    <div className="row mx-0 align-items-center flex-md-row gap-lg-0 gap-3">
                        ...
                        <div className="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3 col-xxl-4">
                            <div className='text-start'>
                                ...
                                { props.decreasevalue ? <h5 className=" mb-0 fw-500 text__red helvetica">▼{props.decreasevalue}</h5> : <h5 className=" mb-0 fw-500 text__green helvetica">▲{props.increasevalue}</h5> }
                ...
                <Chart  desc='The solution to make Open-Source as Competitive as Closed Source' chatData={chartData} title='xMoney' smTitle='UTK' imgd={xMoneyImg} price={0.5227} profitPrice={-4.17} />
                </div>
