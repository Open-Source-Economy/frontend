        ...
        <div className='overflow-hidden' style={{ width: "100%", height: "100%", borderRadius: "20px", backgroundColor: "#132743" }}>
            ...
            <div className='flex py-3 px-3 justify-between items-center my-1 mb-3 d-none'>
                ...
                <div className='flex gap-2 w-[70%]'>
                    ...
                    <div>
                        <p className=' text-[16px] ssm:text-[18px] xsm:text-[22px] sm:text-[24px] font-mono font-bold text-color-main'>{title}<span className='text-[18px] font-medium ml-1 uppercase'>{smTitle}</span></p>
                ...
                <div>
                    ...
                    <p className={` ${profitPrice > 0 ? "text-[#40BF6A]" : "text-[#DF2040]"} text-[14px] sm:text-[18px] font-mono font-normal`}>{profitPrice < 0 ? < AiOutlineArrowDown className='inline-block' /> : <AiOutlineArrowUp className='inline-block' />} {profitPrice}%</p>
            ...
            <ResponsiveContainer width="100%" height="100%">
                ...
                >
                    ...
                    <Tooltip contentStyle={{ background: "transparent", fontFamily: "monospace", fontSize: "16px", fontWeight: "300", borderRadius: "10px" }} labelStyle={{ display: "none", }} />
                </AreaChart>
            </ResponsiveContainer>
        </div>
