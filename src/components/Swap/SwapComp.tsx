    ...
    return (
        <>
            <div className="swapc">
                ...
                <div className={swap ? "mt-3 d-flex flex-column-reverse gap-1 align-items-center position-relative" : "mt-3 d-flex flex-column gap-1 align-items-center position-relative"}>
                    <div className="swapdiv w-100 px-3 py-3">
                        <div className="d-flex justify-content-between ">
                            <div>
                                {swap ? <p className='text-white-50 helvetica'>
                                    You Get
                                </p> : <p className='text-white-50 helvetica'>
                                    You Pay
                                </p>}
                                ...
                                <input type="text"
                                    ...
                                    onChange={handleInputChange} className="bg-transparent border-0 h3 text-white nofocus" placeholder='0' />
                                <p className='text-white-50 mb-0 helvetica'>
                                    $1.63
                                </p>
                            </div>
                            <div>
                                ...
                                {swap ?
                                    ...
                                    : <p className='text-white text-end mb-0 helvetica fw-600'>
                                        Balance :1.58 <button className="text__primary bg-transparent nofocus  border-0" onClick={() => { setInputValue("1.58"); setInputValue2(`${1.58 * 137}`) }}> Max</button>
                                    </p>
                                }
                            </div>
                        </div>
                    ...
                    <div className="swapdiv w-100 px-3 py-3">
                        <div className="d-flex justify-content-between">
                            <div>
                                ...
                                maxLength={10}
                                    value={inputValue2}
                                    className="bg-transparent border-0 h3 text-white nofocus" placeholder='0' onChange={handleInputChange2} />
                                <p className='text-white-50 mb-0  helvetica'>
                                    $1.63
                                </p>
                            </div>
