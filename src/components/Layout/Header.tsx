            ...
            <header>
                <nav className='container pt-4'>
                    <div className="d-flex justify-content-between flex-lg-nowrap flex-wrap gap-lg-0 gap-3">
                        ...
                        {
                            props.islogin ? <div className='d-flex gap-2'>
                                <Dropdown>
                                    ...
                                    <Dropdown.Menu >
                                        <Dropdown.Item href="#/action-1">   <img src={solicon3} style={{ width: "50px" }} className='me-2' alt="" />
                                            SOL</Dropdown.Item>
                                        <Dropdown.Item href="#/action-2">   <img src={solicon3} style={{ width: "50px" }} className='me-2' alt="" />
                                            SOL</Dropdown.Item>
                                        <Dropdown.Item href="#/action-3">   <img src={solicon3} style={{ width: "50px" }} className='me-2' alt="" />
                                            SOL</Dropdown.Item>
                                    </Dropdown.Menu>
                                </Dropdown>
                    ...
                    {props.islogin ?
                      ...
                      Connect A Wallet
                        ...
                        <div className="bg__blue d-flex rounded py-3 align-items-center justify-content-between px-3 mt-4">
                            ...
                            {props.islogin ?
                            <Link to="/" onClick={handleClose} className='connect__btn2 text-decoration-none  small'>Disconnect</Link>
                            :
                            <Link to="/swap" onClick={handleClose} className='connect__btn2 text-decoration-none small'>Connect</Link>
                            }
                        </div>
