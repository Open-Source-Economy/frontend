...
class OnboardingBackendAPIImpl implements OnboardingBackendAPI {
  ...
  async createProfile(profileData?: dto.CreateDeveloperProfileDto): Promise<dto.OnboardingResponse | ApiError> {
    return handleError<dto.OnboardingResponse>(
      () => axios.post(`${this.baseUrl}/profile`, profileData || {}, { withCredentials: true }),
      "createProfile"
    );
  }
  ...
  async updateProfile(updates: dto.UpdateDeveloperProfileDto): Promise<dto.OnboardingResponse | ApiError> {
    return handleError<dto.OnboardingResponse>(
      () => axios.put(`${this.baseUrl}/profile`, updates, { withCredentials: true }),
      "updateProfile"
    );
  }
  ...
  async getDeveloperProfile(): Promise<dto.GetDeveloperProfileResponse | ApiError> {
    return handleError<dto.GetDeveloperProfileResponse>(
      () => axios.get(`${this.baseUrl}/profile`, { withCredentials: true }),
      "getDeveloperProfile"
    );
  }
  ...
  async addRepository(repository: dto.AddRepositoryDto): Promise<dto.AddRepositoryResponse | ApiError> {
    return handleError<dto.AddRepositoryResponse>(
      () => axios.post(`${this.baseUrl}/repositories`, repository, { withCredentials: true }),
      "addRepository"
    );
  }
  ...
  async updateDeveloperRights(id: string, updates: dto.UpdateDeveloperRightsDto): Promise<dto.OnboardingResponse | ApiError> {
    return handleError<dto.OnboardingResponse>(
      () => axios.put(`${this.baseUrl}/rights/${id}`, updates, { withCredentials: true }),
      "updateDeveloperRights"
    );
  }
  ...
  async completeOnboarding(): Promise<dto.CompleteOnboardingResponse | ApiError> {
    return handleError<dto.CompleteOnboardingResponse>(
      () => axios.post(`${this.baseUrl}/complete`, {}, { withCredentials: true }),
      "completeOnboarding"
    );
  }
}