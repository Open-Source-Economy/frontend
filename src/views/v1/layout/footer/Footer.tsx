...
import { SocialMedia } from "src/views/v1/components/socialMedia/SocialMedia";
import AOS from "aos";
...
export function Footer() {
  ...
  return (
    <div className="bg-[url('./assets/v1/bg-2.svg')] max-[1100px]:bg-none bg-cover bg-right relative overflow-hidden">
      <div className="bg-[url('./assets/v1/bg-1.png')] max-[1100px]:bg-none bg-cover bg-left">
        <div className="bg-[url('./assets/v1/boxes.png')] bg-auto bg-no-repeat bg-[position:743px_0%] 1200:bg-[position:743px_0%] md:bg-[position:492px_0%]">
