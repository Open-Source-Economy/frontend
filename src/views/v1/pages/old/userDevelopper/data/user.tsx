...
import img2 from "src/assets/v1/icon/sec2img3.png";
import img3 from "src/assets/v1/lock.png";
import img4 from "src/assets/v1/icon/userimg1.png";
import img1 from "src/assets/v1/source.png";
import bgText from "src/assets/v1/bg-text-2.png";
import devBg from "src/assets/v1/developer-bg1.webp";
import "aos/dist/aos.css";
import { SolutionProps } from "../elements/Solution";
import primaryProblemsSrc from "src/assets/v1/btn.png";
import secondaryProblemsSrc from "src/assets/v1/developerbannertext.png";
