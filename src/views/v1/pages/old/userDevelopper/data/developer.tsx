...
import img2 from "src/assets/v1/developerimg1.png";
import img3 from "src/assets/v1/developerimg2.png";
import img4 from "src/assets/v1/icon/sec2img.png";
import bgText from "src/assets/v1/userbannertext.png";
import secondaryProblemsSrc from "src/assets/v1/userbannertext.png";
import primaryProblemsSrc from "src/assets/v1/btn2.png";
import { SolutionProps } from "../elements/Solution";
import { UserDeveloperProps } from "src/views/index";
import { Audience } from "../../../../../Audience"; // Do not change the import to src/, it does not work
import devBg from "src/assets/v1/developer-bg.webp";
import img1 from "src/assets/v1/source.png";
