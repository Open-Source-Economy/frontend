    ...
    >
      <div className="flex justify-center mb-4">
        <img
          src={props.cardIcon}
          alt={props.title}
          className="3xl:w-[133px] h-24 w-24 xl:w-28 xl:h-28 object-contain 3xl:h-[133px]"
        />
      </div>
      ...
      <p className="text-lg 3xl:text-[22px] leading-tight xl:w-[80%] mx-auto text-center opacity-80">
        {props.description}
      </p>
    </div>
  );
