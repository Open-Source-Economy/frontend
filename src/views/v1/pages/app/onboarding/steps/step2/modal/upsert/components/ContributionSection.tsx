    ...
    <div className="flex p-9 flex-col justify-end items-end gap-2.5 self-stretch rounded-[30px] bg-[#14233A]">
      ...
      <div className="flex items-start gap-5 self-stretch">
        ...
        <div className="flex-1">
          <DeveloperRoleTypeSelectInput required value={props.selectedRole} onChange={props.onRoleChange} ref={props.roleSelectRef} />
        </div>

        {/* Merge Rights Dropdown */}
        <div className="flex-1">
          <MergeRightsTypeSelectInput required value={props.selectedMergeRights} onChange={props.onMergeRightsChange} ref={props.mergeRightsSelectRef} />
        </div>
      </div>
    </div>
  );
