...
export function Cards2(props: Cards2Props) {
  ...
  return (
    ...
    >
      <div
        className={`absolute top-0 left-0 size-full gradient-bg duration-300 group-hover:!opacity-100 opacity-0`}
      ></div>
        ...
        <div className="flex flex-col items-center justify-between">
          <div className="grid md:size-[144px] size-[100px] place-items-center overflow-hidden rounded-full border-1 border-gray-300 bg-[length:100%_100%] p-0">
            {props.owner.displayAvatarUrl && (
              <img src={props.owner.displayAvatarUrl} className="size-full object-cover object-center" alt="" />
            )}
          </div>
          <div className="max-[860px]:min-h-[100px]">
            ...
            <div className={`h-1 w-[149px] mx-auto duration-300 mt-6 bg-white  relative `}>
              <div
                className={`absolute top-0 left-0 w-full h-full gradient-bg duration-300 group-hover:!opacity-100 opacity-0`}
              ></div>
            </div>
        ...
        <div className="w-full flex justify-center relative z-20">
          {props.action && props.to && (
            <Button
              ...
              size="MEDIUM"
              asChild
              className="w-full after:!w-[98.5%]"
              parentClassName="w-10/12 "
            >
