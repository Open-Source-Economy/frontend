        ...
        <div className="px-10 md:px-12 xl:px-14 2xl:px-[70px] w-full">
          <div className="flex items-center justify-between">
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                type="checkbox"
                checked={noRequestedAmount}
                onChange={(e) => setNoRequestedAmount(e.target.checked)}
                className="w-4 h-4"
              />
          ...
          <div
            className={`!mt-4 bg-[rgba(255,255,255,10%)] rounded-[10px] py-[12px] px-3 w-[100%] ${noRequestedAmount ? "opacity-50" : ""}`}
          >
            <CounterInput
              credit={counter}
              increment={increment}
          ...
          <div className="flex items-start mt-3 !gap-3 mb-10">
            ...
            <h2 className="xl:text-lg font-normal text-start">
              I will split fairly the amount collected among contributors and reviewers
            </h2>
          </div>
