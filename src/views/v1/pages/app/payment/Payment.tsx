...
import bg from "src/assets/v1/paymentbg.png";
import { Coupon, MonthlySubscription, OneTimePayment, PriceItems } from "src/views/v1/pages/app/payment/elements";
import { PaymentOptions } from "src/views/v1/pages/app/payment/elements/PaymentOptions";
