...
export function CompanyNumberBanner(props: CompanyNumberBannerProps) {
  return (
    <section>
      <div className="relative rounded-2xl xl:rounded-[25px] bg-no-repeat bg-[url('src/assets/v1/company-banner.webp')] 3xl:!max-w-[1560px] max-w-[800px] mx-auto bg-center bg-cover py-[22px] !px-4 3xl:px-[30px] flex !gap-3 3xl:!gap-4 500:flex-row flex-col overflow-hidden xl:bg-full items-center justify-center">
