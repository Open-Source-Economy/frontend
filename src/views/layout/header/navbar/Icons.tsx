  ...
  return (
    <svg width="18" height="19" version="1.1" id="fi_482506" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 469.333 469.333">
      <g>
        <g>
          <path
            className="duration-200 group-hover:fill-[#FF518C]"
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="18" height="19" x="0" y="0" viewBox="0 0 24 24">
      <g>
        ...
        <path
          className="duration-200 group-hover:fill-[#FF518C]"
          d="M12 14a1 1 0 0 0 1-1v-3a1 1 0 0 0-2 0v3a1 1 0 0 0 1 1z"
          fill="#ffffff"
          opacity="1"
          data-original="#000000"
        ></path>
        <circle className="duration-200 group-hover:fill-[#FF518C]" cx="12" cy="7" r="1" fill="#ffffff" opacity="1" data-original="#000000"></circle>
      </g>
    </svg>
  );
}
  ...
  return (
    <svg width="18" height="19" viewBox="0 0 18 19" fill="none" className="w-6 h-6">
      ...
      <path
        ...
        className="stroke-current duration-200 group-hover:stroke-[#FF518C]" // Apply gradient on hover
      />
      <path
      ...
      <path
        ...
        className="stroke-current duration-200 group-hover:stroke-[#FF518C]"
      />
      <path d="M11.25 5.04687V3.54688" strokeLinecap="round" className="stroke-current duration-200 group-hover:stroke-[#FF518C]" />
    </svg>
  );
}
...
export const BillingIcon = () => {
  return (
    <svg width="18" height="19" viewBox="0 0 18 19" fill="none" className="group w-6 h-6">
      ...
      <path d="M8.25 8.79688H6" className="stroke-white duration-200 group-hover:stroke-[#FF518C] " strokeLinecap="round" strokeLinejoin="round" />

      {/* Path 3 with duration-200 group-hover to apply gradient stroke on hover */}
      <path d="M10.5 5.79688H6" className="stroke-white duration-200 group-hover:stroke-[#FF518C] " strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
};
...
export const EuroIconTwo = () => {
  return (
    <svg width="18" height="19" viewBox="0 0 18 19" fill="none" className=" w-6 h-6">
      ...
      <path d="M3.75 8.04688H9.75" className="stroke-current duration-200 " strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M3.75 11.0469H9.75" className="stroke-current duration-200 " strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path
        d="M14.25 13.7526C13.402 15.2772 11.859 16.2969 10.0961 16.2969C7.4197 16.2969 5.25 13.9464 5.25 11.0469V8.04688C5.25 5.14738 7.4197 2.79688 10.0961 2.79688C11.859 2.79688 13.402 3.81656 14.25 5.34118"
        className="stroke-current duration-200 group-hover:stroke-[#FF518C]"
        strokeWidth="1.5"
...
export const InvoiceIcon = () => {
  return (
    <svg width="18" height="19" viewBox="0 0 40 40" fill="none" className="group w-6 h-6">
      <defs>
