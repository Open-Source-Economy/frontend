export function AvailableFunding() {
  return (
    <svg width="18" height="19" version="1.1" id="fi_482506" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 469.333 469.333">
      <g>
        <g>
          <path className="duration-200 group-hover:fill-[#FF518C]"
    ...
    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="18" height="19" x="0" y="0" viewBox="0 0 24 24">
      <g>
        <path className="duration-200 group-hover:fill-[#FF518C]"
          ...
          data-original="#000000"
        ></path>
        <path className="duration-200 group-hover:fill-[#FF518C]" d="M12 14a1 1 0 0 0 1-1v-3a1 1 0 0 0-2 0v3a1 1 0 0 0 1 1z" fill="#ffffff" opacity="1" data-original="#000000"></path>
  ...
  return (
    <svg width="18" height="19" viewBox="0 0 18 19" fill="none" className=" w-6 h-6">
      ...
      <path
        ...
        className="stroke-current duration-200 "
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
