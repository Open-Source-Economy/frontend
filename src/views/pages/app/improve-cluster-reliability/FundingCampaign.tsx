        ...
        <div className="max-w-[800px] relative z-10 w-full xl:!w-[59%] 3xl:w-[817px] mx-auto xl:!mx-0">
          ...
          {donationType === "once" && (
            <>
              ...
              <p className="font-montserrat text-center !leading-[154%] xl:!text-left text-base sm:text-xl mx-auto xl:!mx-0 font-medium xl:text-2xl max-w-[650px] w-full 3xl:max-w-[770px] 3xl:text-[30px] !mt-6 xl:!mt-9 3xl:!mt-11">
                Apache Pekko is an independent open-source project powered by volunteers in their free time.
              </p>
              <p className="font-montserrat text-base text-center xl:!text-left sm:text-left sm:text-xl font-medium xl:text-2xl 3xl:text-[30px] xl:!my-6 !my-4 3xl:!my-8">
                We need your help.{" "}
              </p>
            </>
          )}
