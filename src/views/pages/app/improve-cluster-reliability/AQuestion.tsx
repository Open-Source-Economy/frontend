...
const AQuestion = () => {
  return (
    <section className="!px-4 pb-16 3xl:pb-24 relative flex flex-col">
      ...
      ></div>
      <div
        className="bg-gradient-to-l from-[#5935A1] to-[#AC3556] min-h-[1056px] min-w-[280px] max-w-[364px] w-full h-full absolute right-[3%] 3xl:right-[11%] -top-[60%] 3xl:-top-[90%] blur-[125px] -z-0 opacity-50 shrink-0 pointer-events-none -rotate-[41.351deg] rounded-[1057px]"
        style={{
          background: `-webkit-linear-gradient(to left, #5935A1, #AC3556)`,
        }}
      ></div>
