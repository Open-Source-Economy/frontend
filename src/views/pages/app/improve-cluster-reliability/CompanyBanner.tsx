    ...
    <>
      ...
      <div className="relative bg-[url('src/assets/company-banner.webp')] bg-cover py-[22px] px-[30px] flex !gap-4 items-center justify-between">
        <div className="flex flex-col items-center !gap-4">
          ...
          <button className="bg-primary-user w-full shadow-[0px_4px_4px_0px_rgba(255,255,255,0.50)_inset,_0px_4px_4px_0px_#09172A] text-white font-semibold py-3 px-6 rounded-[12px] transition-colors">
            {leftButtonText}
          </button>
        </div>

        {/* Simplified cat face */}
        <div className="w-full max-w-[120px] 3xl:max-w-[145px] h-full relative">
          <MascotIcon />
        </div>
        ...
        <div className="flex flex-col items-center !gap-4">
          ...
          <p className="text-lg font-montserrat 3xl:text-[22px] font-bold">Be one of them!</p>
        </div>
      </div>
    </>
  );
