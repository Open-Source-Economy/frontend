...
const UseOfFunds = () => {
  ...
  return (
    <section className="3xl:max-w-[1617px] !px-4 xl:max-w-[90%] 2xl:max-w-[1440px] mx-auto justify-center gap-14 flex items-center xl:flex-row flex-col-reverse 3xl:gap-[112px]">
      ...
      {/* ======= Right Image ====  */}
      <div className="max-w-[590px] 3xl:max-w-[745px] xl:w-1/2  w-full !bg-secondary bg-opacity-30 rounded-full flex justify-center items-center  2xl:pl-4 2xl:pt-14 2xl:pr-24 p-10 2xl:pb-16 shadow-[5px_8px_10px_0px_rgba(255,255,255,0.08)_inset]">
