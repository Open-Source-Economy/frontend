...
const WhyDoWeNeedYourHelp = () => {
  ...
  return (
    <section className="3xl:max-w-[1617px] !px-4 xl:max-w-[90%] 2xl:max-w-[1440px] mx-auto justify-center gap-10 xl:gap-14 flex items-center xl:flex-row flex-col 3xl:gap-[112px] pb-12 xl:pb-0">
      {/* ======= Left Image ====  */}
      ...
      <div className="max-w-[640px] xl:w-1/2 w-full 3xl:max-w-[728px] relative z-20">
        ...
        <ul className="space-y-4 mt-9">
          ...
          {reliableData.map((item, index) => (
            <div key={index} className="flex items-center gap-3 2xl:gap-5 3xl:gap-6 !px-4">
