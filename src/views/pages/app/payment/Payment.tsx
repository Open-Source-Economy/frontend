...
import bg from "/../../../../assets/paymentbg.png";
import img1 from "/../../../../assets/paymentimg1.png";
import clock from "/../../../../assets/sand-clock.png";
import couponimg from "/../../../../assets/codeimg.png";
...
export function Payment(props: PaymentProps) {
    ...
    return (
        <div className="py-16 px-3 flex items-center justify-center mx-auto flex-col">
            ...
            >
                <h1 className="text-[45px] sm:text-[45px] md:text-[62px] text-white text-center">
                    Buy DoW
                </h1>
                        ...
                        <div className="flex flex-column items-center  flex-xxl-row 2xl:items-end  gap-3 mt-5 ">
                            <div className="">
                                <h2
                                    ...
                                    className={`text-center text-[25px] cursor-pointer pt-2 ${
                                        activeBox === 1 ? " opacity-100" : "opacity-50"
                                    }`}
                                >
                                    Buy Credits Now
                                </h2>
                                ...
                                >
                                    ...
                                    <h4 className="text-[16px] text-center text-[#A1A7B0]">
                                        One time payment
                                    </h4>
                                    <div className="mt-6">
                                    ...
                                    <div className="flex items-center gap-3 mt-3">
                                        <img src={img1} className="w-[32px] h-[32px]" alt="" />
                                        <h3 className="text-[15px]  text-[#A1A7B0] line-through">
                                            Back long-term maintenance
                                        </h3>
                                    </div>
                                            ...
                                            <div>
                                                ...
                                                <div className="d-flex items-center gap-2 mt-1">
                                                    ...
                                                    <div className="d-flex flex-col gap-2">
                                                        <img
                                                            src={up}
                                                            className="w-[14px] h-2 cursor-pointer "
                                                            onClick={() => increment()}
                                                            alt=""
                                                        />
                                                        <img
                        ...
                        `}</style>
                            ...
                            <div className="">
                                <h2
                                    ...
                                    className={`text-center text-[25px] cursor-pointer mt-5 mt-lg-0 ${
                                        activeBox === 2 ? " opacity-100" : "opacity-50"
                                    }`}
                                >
                        ...
                        <div className="bg-[#14233A] rounded-[30px] p-4">
                            <div className="relative bg-[#223046] p-1 rounded-[10px] border-2 border-[#FF5E1A] border-dashed max-w-full">
                                <div className="flex flex-col sm:flex-row justify-between items-center">
                                    <img
                                        src={couponimg}
                                        className="absolute lg:top-4 md:top-3 top-4 sm:top-3 left-3 lg:w-8 lg:h-8 w-6 h-6"
                                     />
                                    <input
                                        type="number"
                                        name=""
                            ...
                            <div className="flex justify-between items-center mt-4 pt-3  border-t border-t-[#fff]">
                                <h2 className="text-[16px]">
                                    Total{" "}
                                    <span className="text-[14px] text-[rgba(255,255,255,60%)]">
                    (indl. Taxes)
                  </span>
                                </h2>
                                ...
                                <div className="flex items-start justify-center gap-3  mt-4">
                                    ...
                                    <p className="text-[14px] leading-6 text-[#ffffff]">
                                        ...
                                        <a
                                            ...
                                            className="gradient-text fw-bold hover-effect"
                                        >
                                            Terms of Use
                                        </a>{" "}
                                        and{" "}
                                        <a className="gradient-text fw-bold hover-effect cursor-pointer">
                                            {" "}
                                            Terms of Sales
                                        </a>
                                    </p>
                                ...
                                {modal && (
                                    ...
                                    >
                                        <div className="bg-[#0E1E34] rounded-[50px] py-5 md:px-14 px-3 mx-3 flex items-center justify-center flex-col w-[100%] sm:w-[40%] lg:w-[32%] relative animate-slideInDown">
                                            ...
                                            <h2 className="text-[32px] my-4 text-center">
                                                Payment Error
                                            </h2>
                                            <p className="text-[14px] text-center">
                                                Unfortunately there was an error while processing <br />{" "}
                                                your payment.{" "}
                                            </p>
