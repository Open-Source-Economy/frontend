  ...
  return (
    <PageWrapper baseURL={BaseURL.APP}>
      <div className="py-28 min-h-screen grid place-items-center  relative overflow-hidden">
        <img src={bg} className="absolute -top-[5%] left-1/2 -translate-x-1/2 object-contain  size-[112%]" alt="" />
        <div className="1200:max-w-[957px] max-w-[90%] relative z-20 flex flex-col items-center  mx-auto  bg-primaryBg rounded-[50px]">
          <div className="800:w-[58%] w-full ml-auto flex 800:justify-start justify-end pt-6 md:pr-5 pr-2 sm:pr-12">
            <div className="flex justify-end -mr-6 800:mr-0 lg:w-[176px] lg:mt-24 500:mt-20 400:mt-[70px] mt-[60px]  h-[140px] w-[160px] md:w-[180px] 900:w-[156px] md:h-[200px] lg:h-[242px]">
            ...
            <div className="relative mt-1 flex justify-center pt-[30px] lg:w-[270px] 800:w-[380px] sm:w-[190px] w-[140px] 400:w-[170px] h-[65px] 600:h-auto 500:w-[180px] ">
              ...
              <h4 className="text-center sm:-mt-2 md:-mt-4 800:-mt-1 500:-mt-2 400:-mt-2 -mt-3  lg:text-xl sm:text-sm text-[11px] 400:text-[13px] md:text-base">
                Open Source
          ...
          <div className=" w-full lg:pb-20 pb-9  mt-6 600:mt-0  flex flex-col items-center text-center">
            ...
            <div className=" lg:!px-20  sm:!px-6 px-3    600:mt-0  flex flex-col items-center text-center w-full">
              {config.env !== "production" && (
                <>
                  <div className="border 900:min-w-[726px] sm:min-w-[95%] min-w-[100%] mt-1 border-white rounded-[20px] !p-4 !pr-2 sm:!p-8 mb-8">
