    ...
    <>
      ...
      <div className="!mt-5 lg:!mt-9 bg-[rgba(255,255,255,10%)] rounded-[10px] py-[15px] px-3 w-[100%]">
        <div className="flex items-center gap-4 justify-between">
          ...
          >
            <div className="d-flex flex-col gap-2 lg:!gap-4">
              {/* <img src={up} className="md:w-[22px] w-[18px] h-3 cursor-pointer " onClick={increment} alt="" /> */}
              <span className="md:min-w-[22px] lg:w-full sm:max-w-7 md:h-[18px] max-w-5 cursor-pointer " onClick={increment}>
                <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 27 18" fill="none">
                  <path
              ...
              /> */}
              <span
                className={`md:min-w-[22px] lg:w-full sm:max-w-7 max-w-5 md:h-[18px] cursor-pointer ${
                  counter?.isZero() ? "opacity-50 cursor-not-allowed" : ""
                }`}
                onClick={decrement}
                style={{
                  pointerEvents: counter?.isZero() ? "none" : "auto",
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 27 17" fill="none">
                  <path
