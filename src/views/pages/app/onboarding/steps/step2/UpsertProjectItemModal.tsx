...
import {
  DeveloperProfileId,
  DeveloperProjectItem, DeveloperProjectItemId,
  DeveloperRoleType,
  MergeRightsType,
  ProjectItem,
  ProjectItemId, ProjectItemType
...
export function UpsertProjectItemModal(props: UpsertProjectItemModalProps) {
  ...
  const handleUpsertProject = async () => {
    if (!url || !selectedRoles || !selectedMergeRights) { // TODO: sam implement the error state on the UI please
        ...
        <div className="bg-[#14233a] rounded-[30px] p-8 w-[600px] max-h-[80vh] overflow-y-auto">
          <div className="box-border content-stretch flex flex-col gap-6 items-start justify-start p-0 relative shrink-0 w-full">
            ...
            <div className="box-border content-stretch flex flex-col gap-2 items-start justify-start p-0 relative shrink-0 w-full">
              ...
              />
              {fromError && (
                <p className="text-red-400 text-sm font-montserrat mt-1">{fromError}</p>
              )}
            ...
            <div className="box-border content-stretch flex flex-row gap-4 items-center justify-end p-0 relative shrink-0 w-full">
              ...
              <button
                ...
                className={`bg-gradient-to-r from-[#ff7e4b] via-[#ff518c] to-[#66319b] box-border content-stretch flex flex-row gap-2.5 items-center justify-center px-5 py-3 relative rounded-md shrink-0 transition-all ${!url || !selectedRoles || !selectedMergeRights ? "opacity-50 cursor-not-allowed" : "hover:scale-105"
                }`}
              >
                <div className="font-michroma leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[14px] text-left text-nowrap">
