...
export default function Step5TasksPreferences({ state, updateState, onNext, onBack, currentStep }: Step5TasksPreferencesProps) {
  ...
  const handleAddSelectedTasks = () => {
    const newTasks = selectedTasksInModal.map(taskKey => {
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex flex-row gap-4 items-center">
                              <div className="font-montserrat font-normal text-[#ffffff] text-[14px] text-left">
                                <p className="block leading-[1.4]">Hourly rate: {currencySymbol} {displayRate}</p>
                              </div>
            ...
            >
              ...
              <div className="font-michroma leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[16px] text-left text-nowrap">
                <p className="block leading-[1.5] whitespace-pre">
                  {savingServices ? 'Saving...' : 'Get Started'}
                </p>
              </div>
            </button>
          </div>
                ...
                serviceCategories.map(category => (
                  <div key={category.id}>
                    ...
                    {category.services.map(service => {
                      const taskKey = `${service.id}:${service.name}`;
                      return (
                        <div key={service.id} className="bg-[#202f45] box-border content-stretch flex flex-row gap-2.5 items-center justify-start pl-6 pr-3 py-3 border-b border-[#2a3f56] last:border-b-0">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-[#14233a] rounded-md p-6 w-[500px] border border-[rgba(255,255,255,0.2)]">
            <div className="flex flex-row gap-4 items-center justify-between mb-6">
              ...
              <button
                onClick={() => setShowSelectProjectsModal(false)}
                className="text-[#ffffff] hover:text-[#ff7e4b] transition-colors"
              >
                <CloseIcon />
              </button>
            ...
            <div className="mb-4">
              ...
              <div className="mb-4">
                <p className="font-montserrat font-normal text-[#ffffff] text-[14px] text-left mb-2">
                  For Which Project(s)?
                </p>
                <div className="bg-[#202f45] rounded-md p-3">
                  ...
                  {loadingRepositories ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-4 gap-2">
                      ...
                      <button 
                        onClick={onBack}
                        className="text-[#ff7e4b] hover:text-[#ff518c] transition-colors text-sm underline"
                      >
                        Go back to Step 2
                      </button>
                    </div>
              ...
              <div className="mb-4">
                <p className="font-montserrat font-normal text-[#ffffff] text-[14px] text-left mb-2">
                  Want to change your hourly rate for this service? ℹ️
                </p>
                <div className="flex flex-row gap-2 items-center">
                  <select
                    value={currency}
              ...
              {currentTaskForProjects?.hasResponseTime && (
                <div className="mb-4">
                  ...
                  <p className="font-montserrat font-normal text-[#ffffff] text-[12px] text-left mb-2 opacity-70">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-[#14233a] rounded-md p-6 w-[500px] border border-[rgba(255,255,255,0.2)]">
            <div className="flex flex-row gap-4 items-center justify-between mb-6">
              ...
              <button
                onClick={() => setShowIncidentResponseModal(false)}
                className="text-[#ffffff] hover:text-[#ff7e4b] transition-colors"
              >
                <CloseIcon />
              </button>
