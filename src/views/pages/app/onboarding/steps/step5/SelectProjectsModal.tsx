          ...
          <div className="flex flex-col items-start gap-2 w-full">
            ...
            <div className="flex flex-col items-start gap-0 w-full relative">
              <div className="flex items-start gap-2.5 w-full">
                ...
                >
                  <path d="M24 18.002V30.002M18 24.002H30M24 42C27.5601 42 31.0402 40.9443 34.0003 38.9665C36.9603 36.9886 39.2675 34.1774 40.6298 30.8883C41.9922 27.5992 42.3487 23.98 41.6541 20.4884C40.9596 16.9967 39.2453 13.7894 36.7279 11.2721C34.2106 8.75474 31.0033 7.04041 27.5116 6.34587C24.02 5.65134 20.4008 6.0078 17.1117 7.37018C13.8226 8.73255 11.0114 11.0397 9.03355 13.9997C7.05568 16.9598 6 20.4399 6 24C6 26.976 6.72 29.78 8 32.254L6 42L15.746 40C18.218 41.278 21.026 42 24 42Z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
          ...
          {showCommentInput && (
            <div className="flex flex-col items-start gap-2 w-full mt-4">
              <div className="flex flex-col items-start">
                ...
                <span className="text-white font-montserrat text-[14px] leading-[150%] font-normal opacity-60">
