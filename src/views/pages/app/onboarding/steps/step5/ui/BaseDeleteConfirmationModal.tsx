...
export function BaseDeleteConfirmationModal(props: BaseDeleteConfirmationModalProps) {
  ...
  return (
    <>
      <ModalBackdrop isOpen={isOpen} onClose={onClose} className="relative w-full max-w-[600px] mx-4 bg-[#0E1F35] rounded-[50px] p-12">
        {/* Section Title */}
        <div className="flex flex-col items-center gap-4 self-stretch mb-12">
          <div className="flex flex-col items-center gap-4 self-stretch">
            <div className="flex justify-center items-center gap-2.5 self-stretch">
              <h2 className="flex-1 text-white text-center font-michroma text-[28px] font-normal leading-[130%]">{title}</h2>
            </div>
            <div className="self-stretch text-white text-center font-montserrat text-lg font-normal leading-[150%] opacity-60">{subtitle}</div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-center gap-6">
          ...
          >
            <span className="text-white font-michroma text-base font-normal leading-[150%]">{cancelText}</span>
          </button>
          ...
          >
            <span className="text-white font-michroma text-base font-normal leading-[150%]">{isDeleting ? "Deleting..." : deleteText}</span>
          </button>
        </div>
      </ModalBackdrop>
    </>
