        ...
        {props.developerServices.map((entry, index) => {
          ...
          return (
            <div key={entry.service.id.uuid} className="flex flex-col items-start w-full bg-[#14233A]">
              {/* Service Item */}
              <div className={`flex px-7 py-7 flex-col justify-center items-center gap-4 w-full ${
                ...
                {!hasProjects && (
                  <div className="flex flex-col items-start gap-3 w-full">
                    ...
                    <div className="text-[#FF8C8C] font-montserrat text-[16px] leading-[150%] font-normal">
