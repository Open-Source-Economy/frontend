        ...
        <div className="box-border content-stretch flex flex-col gap-8 items-center justify-center p-0 relative shrink-0 w-[900px]">
          ...
          <div className="flex flex-col gap-12 items-start self-stretch">
            ...
            >
              ...
              >
                <mask id="mask0_add_task" style={{ maskType: "luminance" }} maskUnits="userSpaceOnUse" x="2" y="2" width="20" height="20">
                  <path
                ...
                <g mask="url(#mask0_add_task)">
                  <path d="M1.5 1.5H22.5V22.5H1.5V1.5Z" fill="white" />
                </g>
              </svg>
              <span className="text-white font-michroma text-xs font-normal">Add Task</span>
            </button>
          </div>
