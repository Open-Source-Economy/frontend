    ...
    <div className="flex px-9 py-8 flex-col justify-end items-end gap-8 w-full rounded-[30px] bg-[#14233A]">
      ...
      <div className="flex flex-col items-center gap-1 w-full">
        <div className="flex flex-col items-start gap-4 w-full">
          <h3 className="w-full text-white font-michroma text-[28px] leading-[130%] font-normal">Add Task</h3>
        </div>
      </div>
      ...
      <div className="flex items-center gap-6 w-full">
        ...
        <button
          ...
          className={`flex px-5 py-3 justify-center items-center gap-2.5 rounded-md transition-colors ${
            isAddButtonDisabled ? "bg-[#202F45]" : "bg-[#202F45] hover:bg-[#2a3f56]"
          }`}
        >
          ...
          <span className="text-white font-michroma text-[12px] leading-normal font-normal">Add</span>
        </button>
      </div>
    </div>
  );
