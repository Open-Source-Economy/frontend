...
export const RoyaltiesIcon = () => (
  <div className="w-[120px] h-[120px] flex items-center justify-center">
    <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="60" cy="60" r="60" fill="#FF7E4B" opacity="0.1"/>
      <path d="M45 45L75 75M75 45L45 75" stroke="#FF7E4B" strokeWidth="4" strokeLinecap="round"/>
      <circle cx="45" cy="45" r="8" fill="#FF7E4B"/>
      <circle cx="75" cy="75" r="8" fill="#FF7E4B"/>
    </svg>
  </div>
);
...
export const DonationsIcon = () => (
  <div className="w-[120px] h-[120px] flex items-center justify-center">
    <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="40" y="35" width="40" height="50" rx="8" fill="#FF7E4B" opacity="0.8"/>
      <rect x="35" y="45" width="50" height="8" rx="4" fill="#FF7E4B"/>
      <circle cx="60" cy="25" r="8" fill="#FF7E4B"/>
    </svg>
  </div>
);
...
export function FundingCard(props: FundingCardProps) {
  ...
  return (
    <div className={`flex flex-col p-8 gap-9 bg-[#14233A] rounded-[30px] flex-1 transition-all duration-300 ${
      ...
      <div className="flex items-center justify-between w-full">
        ...
        {isRecommended && (
          <div className="flex items-center gap-2 px-2.5 py-0.5 bg-[#FF7E4B] rounded-[50px]">
            <FireIcon />
            <span className="text-white font-montserrat text-sm leading-[1.5]">Recommended</span>
          </div>
        )}
      </div>
      ...
      <div className="flex items-start gap-6 w-full">
        ...
        <div className="flex flex-col gap-3 flex-1">
          <h3 className="text-[#FF7E4B] font-michroma text-[28px] leading-[1.3]">
            {title}
          </h3>
          <p className="text-white font-montserrat text-base leading-normal">
            {description}
          </p>
          {hasLearnMore && onLearnMore && (
            <button 
              onClick={onLearnMore} 
              className="text-white font-montserrat text-base underline hover:text-[#FF7E4B] transition-colors text-left opacity-60 hover:opacity-100"
            >
              Learn more
            </button>
          )}
