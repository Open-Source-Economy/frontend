...
export const ServicesIcon = () => (
  <div className="w-[120px] h-[120px] relative">
    ...
    {/* Overlay effects */}
    <div
      className="w-[104px] h-[111px] absolute left-0 top-2 opacity-60 backdrop-blur-[2.4px] rounded-sm"
      style={{
        background:
...
export function FundingCard(props: FundingCardProps) {
  ...
  return (
    <div
      className={`flex flex-col p-8 gap-9 bg-[#14233A] rounded-[30px] flex-1 transition-all duration-300 ${
    ...
    >
      ...
      <div className="flex items-start gap-6 w-full">
        ...
        <div className="flex flex-col gap-3 flex-1">
          <h3 className="text-[#FF7E4B] font-michroma text-[28px] leading-[1.3]">{title}</h3>
          <p className="text-white font-montserrat text-base leading-normal">{description}</p>
