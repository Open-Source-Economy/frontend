...
export interface Step2InvolvementProps extends OnboardingStepProps<Step2State> {}

export default function Step2Involvement(props: Step2InvolvementProps) {
...
// import { getOnboardingBackendAPI } from "src/services/OnboardingBackendAPI";
// import { OnboardingStepProps } from "./OnboardingStepProps";
// import { Step1State, Step2State } from "../OnboardingDataSteps";
//
// interface Project {
//   id: string;
//   organization: string;
...
//   const [projects, setProjects] = useState<Project[]>(props.state.involvement?.projects || []);
//
//   // Modal form state
