...
import { participants } from "../whoBuiltIt/Helper";
...
const Participants = () => {
  return (
    <section className="pb-20 3xl:pb-40 relative">
      ...
      />
      <img src={offerLeftLinear} alt="" className="absolute max-w-[670px] w-full -z-10 pointer-events-none left-[-10%] opacity-70 -top-[15%] xl:-top-[26%] " />

      <div className="3xl:max-w-[1520px] w-full !px-4 xl:max-w-[90%] mx-auto text-center">
        {/* Title */}
        <h2 className="section-heading mx-auto lg:!pb-5 w-fit relative mb-10 md:mb-14">
          Who is Participating?
          <span className="absolute w-[60%] h-[6px] hidden lg:block left-1/2 -translate-x-1/2  bg-gradient-to-r from-[#FF7E4B] via-[#FF518C] to-[#66319B] bottom-0"></span>
        </h2>
