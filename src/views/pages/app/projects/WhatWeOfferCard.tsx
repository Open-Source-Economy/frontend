...
const WhatWeOfferCard = ({ card }: { card: CardData }) => {
  return (
    <article className="relative p-[1px] max-w-[500px]  lg:max-w-[690px] w-full h-full rounded-[20px] 2xl:rounded-[28px] 3xl:rounded-[35px] bg-gradient-to-r from-[#FFFFFF14] to-[#66666636]">
      ...
      <div className="!bg-secondary h-full rounded-[20px] 2xl:rounded-[28px] 3xl:rounded-[35px] py-6  md:py-10 3xl:py-[57px] !px-4 2xl:!px-6 3xl:!px-8">
        <div className="flex 500:flex-row items-center 500:items-start flex-col !gap-5 lg:!gap-8 3xl:!gap-16">
          <div className="min-w-[50px] max-w-[80px] 2xl:max-w-[120px] 3xl:max-w-[143px]">
