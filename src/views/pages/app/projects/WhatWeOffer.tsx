...
const WhatWeOffer = () => {
  return (
    <section className="relative pt-6 xl:pt-10">
      ...
      <div className="!px-4 lg:!px-6 xl:!px-0 xl:max-w-[86%] w-full 2xl:max-w-[80%] 3xl:max-w-[1440px] mx-auto relative z-20 ">
        <div className="grid lg:place-items-start w-full place-items-center grid-cols-1 lg:grid-cols-2  !gap-5 3xl:!gap-10">
