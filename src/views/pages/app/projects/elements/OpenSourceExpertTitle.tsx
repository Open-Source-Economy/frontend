  ...
  return (
    <>
      ...
      <section className="w-full pt-20 lg:!pt-32 3xl:!pt-[141px] pb-10 max-w-[1164px] relative 3xl:max-w-[1376px] !px-4 mx-auto">
        ...
        <h3 className="text-[21px] md:text-2xl lg:text-3xl xl:text-[33px] text-center font-montserrat 3xl:text-[40px] mt-10 sm:mt-12 md:mt-[60px] max-w-[320px] 500:max-w-[470px] mx-auto">
          Need help with an Open Source project?
        </h3>
        <h5 className="font-montserrat text-base xl:text-lg 2xl:text-xl 3xl:text-2xl text-center opacity-70 !mt-5 max-w-[320px] 500:max-w-[470px] mx-auto">
