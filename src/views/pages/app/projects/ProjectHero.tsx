  ...
  return (
    <>
      ...
      <section className="relative w-full !pt-10 px-4 xl:!pt-20">
        <h1 className="relative  text-center mx-auto 3xl:!mt-[141px]  who-built-it-main-heading ">
        ...
        <h3 className="text-xl md:text-2xl font-medium lg:text-3xl max-w-[80%] md:max-w-[586px] mx-auto xl:text-[33px] font-mdeium text-center font-montserrat 3xl:text-[40px] mt-10 sm:mt-12 md:mt-[60px] 2xl:mt-20">
          What do we offer?
        </h3>
