    ...
    <>
      ...
      <section className="relative w-full !pt-10 px-4 xl:!pt-20 flex flex-col items-center">
        ...
        <img
          src={whoBuiltHero}
          alt=""
          className="absolute pointer-events-none sm:max-w-[80%] w-full lg:max-w-[75%] xl:max-w-[802px] object-contain -translate-x-1/2 left-1/2 -z-10 top-[1%] opacity-40 md:opacity-30"
        />
        ...
        <h3 className="text-xl md:text-2xl font-medium lg:text-3xl max-w-[80%] md:max-w-[586px] mx-auto xl:text-[33px] font-mdeium text-center font-montserrat 3xl:text-[40px] mt-10 sm:mt-12 3xl:mt-14">
          What do we offer?
        </h3>
