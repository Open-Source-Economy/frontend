...
const ErrorModal: React.FC<ErrorModalProps> = ({ showNetworkErrorModal, setShowNetworkErrorModal }) => {
  if (!showNetworkErrorModal) return null; // Do not render the modal if `shownetworkerrormodal` is false
      ...
      <div className="h-[173px] max-w-[476px] relative w-full px-3 sm:px-0">
        ...
        <div className="border !border-[#FF595B] p-4 bg-[#0E1F35] rounded-xl relative">
          ...
          <div
            ...
            onClick={() => setShowNetworkErrorModal(false)} // Close modal on click
          >
            <IoCloseOutline />
          </div>
        </div>
