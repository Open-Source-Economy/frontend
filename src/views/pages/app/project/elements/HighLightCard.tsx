...
cursor-pointer !bg-primaryBg text-white rounded-[20px] 2xl:rounded-[28px] 3xl:rounded-[35px] py-8 !px-5 xl:!px-7 xl:!pt-14 xl:!pb-9 3xl:!px-8 3xl:!pt-16 3xl:!pb-10 flex flex-col hover:shadow-[0px_0px_50px_0px_rgba(208,102,99,0.28)] z-20 duration-300 ease-linear transition-shadow`}
    >
      {/* Card Title */}
