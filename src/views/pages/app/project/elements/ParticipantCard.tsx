...
export function ParticipantCard(props: ParticipantCardProps) {
  return (
    <Link to={props.maintainer.link} className="relative z-20 max-w-[250px] 500:max-w-[294px] flex flex-col items-center text-white ">
      {/* Participant Image */}
      <img
        src={props.maintainer.image}
        alt={props.maintainer.name}
      ...
      <h3 className="font-montserrat font-semibold text-xl 2xl:text-2xl 3xl:text-[28px] !mt-4 3xl:!mt-[18px]">{props.maintainer.name}</h3>
