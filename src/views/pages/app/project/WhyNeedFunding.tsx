...
const WhyNeedFunding: React.FC = () => {
  ...
  return (
    <div className="2xl:pt-28 pt-10 pb-10 md:pb-16 relative">
      ...
      />
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8  xl:gap-14 place-items-center !px-4 lg:!px-6 xl:!px-0 xl:max-w-[86%]  2xl:max-w-[85%] 3xl:max-w-[1659px] mx-auto">
        {/* Left side - Image */}
