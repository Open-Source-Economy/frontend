  ...
  return (
    <PageWrapper baseURL={BaseURL.APP}>
      <div className="max-w-[1376px] !px-4 mx-auto flex flex-col items-center">
        <h1 className="!mt-20 lg:mt-[141px] text-3xl md:text-4xl lg:text-5xl xl:text-[62px]  bg-gradient-to-r from-[#FF7E4B] via-[#FF518C] to-[#66319B] w-fit text-transparent bg-clip-text font-michroma">
          Open Source
        </h1>
        ...
        <h5 className="font-montserrat text-xl text-center lg:text-2xl opacity-70 !mt-5">We're the experts who build, debug, and maintain it</h5>
