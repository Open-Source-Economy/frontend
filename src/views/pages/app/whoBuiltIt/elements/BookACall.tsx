  ...
  return (
    <section className="max-w-[1164px] relative 3xl:max-w-[1376px] px-4 mx-auto">
      ...
      <div className="relative !mt-7 md:!mt-12 flex justify-center items-center">
        <button className="bg-gradient-to-r font-michroma relative overflow-hidden flex justify-center items-center gap-2 h-14 lg:h-16 lg:text-lg from-[#FF7E4B]  via-[#FF518C] to-[#66319B] 3xl:h-[75px] min-w-[210px] hover:bg-transparent after:absolute after:w-[98%] after:top-1/2 after:left-1/2 after:bg-secondary after:h-[93%] after:-translate-x-1/2 after:-translate-y-1/2 after:rounded-md after:opacity-0 after:hover:opacity-100 after:duration-300 rounded-md">
