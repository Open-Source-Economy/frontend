...
const ServiceBox: React.FC<ServiceBoxProps> = ({ data }) => (
  <div className="rounded-2xl cursor-pointer group service-card 3xl:rounded-[35px] sm:min-w-[470px] w-full sm:max-w-[668px] backdrop-blur-[35px] !px-4 !pt-4 !pb-7">
    ...
    <div className="relative !mt-7 lg:!mt-10 3xl:!mt-12">
      {data.buttonText && (
        <button className="h-11 w-full rounded-md 3xl:h-[61px] min-w-[210px] ease-in-out bg-[#1a2a3f] bg-gradient-to-r from-transparent via-transparent to-transparent group-hover:from-[#FF7E4B] group-hover:via-[#FF518C] group-hover:to-[#66319B] lg:h-14 transition-all duration-300 lg:text-lg 3xl:text-2xl text-base">
