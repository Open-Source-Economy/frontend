...
const ServiceBox: React.FC<ServiceBoxProps> = ({ data }) => (
  <div className="rounded-2xl cursor-pointer service-card 3xl:rounded-[35px] sm:min-w-[470px] w-full sm:max-w-[668px] bg-[rgba(20,35,58,0.79)] backdrop-blur-[35px] !px-4 !pt-4 !pb-7">
