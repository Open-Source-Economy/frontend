...
import { ProjectHero } from "src/views/pages/project/sections/ProjectHero";
...
import { useProjectDetails } from "src/views/pages/project/hooks/useProjectDetails";
import { TrustIndicatorGroup, type TrustIndicatorItem } from "src/views/pages/project/components/TrustIndicators";
import { getProjectDisclaimer } from "src/views/pages/project/data/projectDisclaimers";
...
import { FundDistributionVisualization } from "src/views/pages/project/sections/FundDistributionVisualization";
