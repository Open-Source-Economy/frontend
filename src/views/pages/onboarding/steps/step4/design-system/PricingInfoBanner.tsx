    ...
    <div className="flex items-start gap-2 p-3 bg-brand-neutral-200/50 rounded-lg border border-brand-neutral-300/30">
      ...
      <div className="flex-1 space-y-2">
        <p className="text-xs text-brand-neutral-600">
          The enterprise will pay more than your service rate. We'll work to negotiate the best rate for you to maximize
          both your income and ecosystem contributions.
        </p>
