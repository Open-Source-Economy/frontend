  ...
  return (
    <div className="flex flex-col items-start self-stretch rounded-[30px]">
      ...
      {props.projects.map((entry, index) => (
        ...
        >
          <div
            className={`flex pb-5 justify-center items-center gap-6 self-stretch ${index < props.projects.length - 1 ? "border-b border-[#0E1F35]" : ""}`}
          >
            <div className="flex items-start gap-2.5 flex-1">
              ...
              <svg
                className="w-0 self-stretch stroke-white opacity-20"
                width="2"
                height="42"
                viewBox="0 0 2 42"
                fill="none"
              ...
              <div className="w-[180px] text-white font-montserrat text-sm font-normal leading-[150%]">
                {entry.developerProjectItem.roles[0]
                  ? DeveloperRoleTypeCompanion.label(entry.developerProjectItem.roles[0])
                  : "No role"}
              </div>
              <svg
                className="w-0 self-stretch stroke-white opacity-20"
              ...
              <div className="flex-1 text-white font-montserrat text-sm font-normal leading-[150%]">
                {entry.developerProjectItem.mergeRights[0]
                  ? MergeRightsTypeCompanion.label(entry.developerProjectItem.mergeRights[0])
                  : "No rights specified"}
              </div>
            </div>
