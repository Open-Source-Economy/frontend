...
export const ParticipationFeatureItem: React.FC<ParticipationFeatureItemProps> = ({ icon: Icon, title, description, variant = "default" }) => {
  if (variant === "compact") {
    return (
      <div className="flex items-center gap-2">
        <Icon className="w-4 h-4 text-brand-success flex-shrink-0" />
  ...
  return (
    <div className="flex items-start gap-3">
      <div className="w-5 h-5 bg-brand-success/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
