  ...
  return (
    <div className="bg-brand-secondary-dark/50 rounded-2xl p-5 border border-brand-neutral-300/10">
      ...
      <div className="space-y-3">
        ...
        <div className="relative">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-gradient-to-br from-brand-success to-brand-success-dark rounded-lg flex items-center justify-center flex-shrink-0">
          ...
          <div className="absolute left-5 top-10 w-px h-3 bg-gradient-to-b from-brand-success to-transparent" />
        </div>
