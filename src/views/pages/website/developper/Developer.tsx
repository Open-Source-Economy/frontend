      ...
      <div className="">
        <div className="flex flex-col lg:my-20 my-8  items-center justify-center text-center px-4 md:px-8 lg:px-16">
          ...
          <div className="relative">
            ...
            `}</style>
            <img src={btn2} alt="" className="w-[60%] mx-auto object-contain h-full absolute top-0 left-0 right-0" />
          </div>
        </div>
        <div
          ...
          >
            <div>
              <div data-aos="fade-in" data-aos-duration="35000" className="px-4 mt-12 flex flex-col justify-center items-center gap-16">
                <div className="flex flex-wrap  items-center justify-center gap-12" data-aos="fade-in" data-aos-duration="35000">
                  <div
                    data-aos="fade-in"
                    data-aos-duration="35000"
                  ...
                  <div className="px-2" data-aos="fade-in" data-aos-duration="35000">
                    <h1 className="text-[#FF7E4B] text:xl lg:text-4xl xl:text-5xl">Get Paid</h1>
                    <h2 className="md:text-[20px] xl:text-[24px] xl:leading-7  text-[14px] mt-3 text-gray-200">Earn, Don’t Burn</h2>
                ...
                <div className="flex flex-wrap  items-center justify-center gap-12">
                  ...
                  <div data-aos="fade-in" data-aos-duration="35000" className="px-2">
                    <h1 className="text-[#FF7E4B] text:xl lg:text-4xl xl:text-5xl">Have a Say</h1>
                    <h2 className="md:text-[20px] xl:text-[24px] xl:leading-7  text-[14px] mt-3 text-gray-200">Forget the Far West!</h2>
                ...
                <div className="flex flex-wrap  items-center justify-center gap-12">
                  ...
                  <div data-aos="fade-in" data-aos-duration="35000" className="px-2">
                    <h1 className="text-[#FF7E4B] text:xl lg:text-4xl xl:text-5xl">Fund Your Future</h1>
                    <h2 className="md:text-[20px] xl:text-[24px] xl:leading-7  text-md mt-3 text-gray-200">Stop begging for donations!</h2>
