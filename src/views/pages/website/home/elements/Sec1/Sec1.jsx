...
import {ButtonFindName} from "../../../../../../components/elements/button/ButtonFindName";

const Sec1 = () => { // Defining the Sec1 functional component
  useEffect(() => { // Using the useEffect hook to perform a side effect after the component mounts
    AOS.init({ // Initializing AOS with specific options
      ...
      <div className="sec_1" data-aos="fade-right">
        <div className="d-flex flex-wrap align-items-center">
          <div className="col-lg-6">
            <h1 className="sec1-h1 text-slate-600">Building the <br /> foundation of <br /> open source 3.0</h1>
            <ButtonFindName/>
          </div>
