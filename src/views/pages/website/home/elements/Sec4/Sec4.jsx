...
import videoimg from "../../../../../../assets/videoframe_16852.png"; // Importing the video thumbnail image asset
...
const Sec4 = () => {
  ...
  const [playingVideoId, setPlayingVideoId] = useState(null); // State to track the currently playing video ID
                ...
                (
                    ...
                    >
                      <div className="position-relative videobox px-3 py-3">
                        ...
                        <h1 className="mt-3 video-h1-text">New video youtube</h1>{" "}

                        <h2 className="my-3 video-h2-text">READ MORE</h2>{" "}
