      ...
      <div className="max-w-[1740px] w-full mx-auto relative ">
        <div className="w-full absolute z-[-10] pointer-events-none flex justify-between mt-16">
          <div className="text-[#ffffff1a] leading-[204.348%] font-michroma max-w-[653px] w-full ">
            ...
            <p ref={(el) => (textBlockRefs.current[1] = el!)} className="3xl:text-[28px] lg:text-xl md:text-lg sm:text-base text-sm 3xl:mt-[140px] mx:mt-24 mt-20 text-start max-w-[471px] mx-auto">
              Lack of resources
            </p>
            <p ref={(el) => (textBlockRefs.current[2] = el!)} className="3xl:text-[23px] lg:text-lg md:text-base xs:text-sm text-xs 3xl:mt-[130px] mx:mt-36 sm:mt-16 mt-10 mb-[57px] xl:max-w-[471px]  xl:text-center text-start w-full mx-auto">
          ...
          <div className="text-[#ffffff1a] leading-[204.348%] font-michroma w-full max-w-[636px] ">
            ...
            <p ref={(el) => (textBlockRefs2.current[1] = el!)} className="3xl:text-[31px] md:text-xl sm:text-lg xs:text-base text-sm mb-[60px] lg:mt-[200px] sm:mt-36 mt-20 xl:max-w-[391px] xl:text-center text-end w-full mx-auto">
              Coding for free
            </p>
            <p ref={(el) => (textBlockRefs2.current[2] = el!)} className="3xl:text-[31px]  md:text-xl sm:text-lg xs:text-base text-sm xl:mt-[220px] mx:mt-20 mt-10 xl:text-start text-end xl:max-w-[471px] w-full ">
        ...
        <div className="flex items-center justify-between mx:gap-8 sm:gap-4 gap-3 3xl:max-w-[1290px] max-w-[980px] w-full mx-auto relative 3xl:pt-14 pt-20">
          <div ref={(el) => (subtitlesRef.current[0] = el!)} className="flex items-center justify-center 2xl:text-[23px] xl:text-lg lg:text-base mx:text-sm xs:text-xs text-[10px] font-michroma mx:max-w-[319px] 3xl:min-w-[319px] relative z-10 bg-[#FF7E4B] lg:!p-[15px] xs:p-2 p-1 rounded-[10px] max-w-[319px] w-fit">
            {props.subtittle1}
          </div>
