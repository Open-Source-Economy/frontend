...
export function SolutionImage(props: SolutionImageProps) {
  return (
    <div className="bg-[#14233A] flex items-center justify-center relative rounded-[30px] transition-shadow duration-300 hover:shadow-xl group w-full 2xl:h-[424px] lg:h-[370px] h-[300px] sm:max-h-full !p-10">
