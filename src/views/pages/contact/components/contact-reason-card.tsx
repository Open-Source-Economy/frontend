  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <Icon className={cn("w-5 h-5 flex-shrink-0 mt-0.5", props.isSelected ? "text-brand-accent" : "text-brand-neutral-600")} />
        <div className="flex-1 min-w-0">
          <div className={cn("text-base mb-1", props.isSelected ? "text-brand-neutral-950" : "text-brand-neutral-800")}>{props.label}</div>
