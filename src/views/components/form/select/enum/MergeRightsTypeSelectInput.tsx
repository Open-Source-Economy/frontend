...
import { MergeRightsType } from "@open-source-economy/api-types"; // Import GenericInputRef
...
export const MergeRightsTypeSelectInput = forwardRef(function MergeRightsTypeSelectInput(props: MergeRightsTypeSelectInputProps, ref: Ref<GenericInputRef>) {
  return (
    // @ts-ignore
    <EnumSelectInput<MergeRightsType> label="Merge Rights" enumObject={MergeRightsType} displayedEnums={displayedMergeRights} {...props} ref={ref} />
  );
});
