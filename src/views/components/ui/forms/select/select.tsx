...
function SelectTrigger({
  ...
  const variantStyles = {
    ...
    error:
      "border-brand-error hover:border-brand-error focus:border-brand-error focus:shadow-[var(--form-elevation-error)] focus:ring-brand-error/15",
    warning:
  ...
  const sizeStyles = {
    ...
    default:
      "h-[var(--form-height)] px-[var(--space-form-padding-x)] py-[var(--space-form-padding-y)] text-sm rounded-[var(--form-border-radius)]",
