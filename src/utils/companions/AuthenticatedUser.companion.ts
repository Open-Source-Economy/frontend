...
export const AuthenticatedUserCompanion = {
  getAvatar(user: dto.AuthenticatedUser): string | undefined {
  ...
  getName(user: dto.AuthenticatedUser): string | undefined {
   ...
   */
  getEmailOrGithubLogin(user: dto.AuthenticatedUser): string | undefined {
    return user.user.name ?? undefined;
  },
};
