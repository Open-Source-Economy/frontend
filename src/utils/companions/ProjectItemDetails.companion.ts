...
export namespace ProjectItemDetailsCompanion {
  export function getDisplayName(project: dto.ProjectItemDetails): string | null {
  ...
  export function getDescription(project: dto.ProjectItemDetails): string | null {
    return project.repository?.description ?? null;
  }

  export function getGithubUrl(project: dto.ProjectItemDetails): string | null {
  ...
  export function getProjectItemsStats(projects: dto.ProjectItemDetails[], appendLabels?: boolean): ProjectStats {
